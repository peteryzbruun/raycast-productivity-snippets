...
I have used Raycast snippets for a few years as my text expander and prompt library. I spent time looking for public repositories with practical Raycast snippet systems I could copy, clone, or learn from, but I did not find much that matched how I actually work.
...
* Raycast snippet JSON exports
* AI prompt snippets
* Productivity snippets
* Writing and rewriting blocks
* Coding and CLI prompt starters
